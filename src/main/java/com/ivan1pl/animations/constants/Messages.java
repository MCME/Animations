...
public class Messages {
    ...
    public static final String MSG_MOVING_ANIMATION_EDIT_INFO =
            "Editing {0}, step: ({1}, {2}, {3}), maximum distance: {4}, interval = {5}. Available operations:\n{6}";

    public static final String MSG_STATIONARY_ANIMATION_EDIT_INFO_SIMPLE =
    ...
    public static final String MSG_INVALID_STEP =
            "Failed to set step to ({0}, {1}, {2}) - step distance must not be 0.";

    public static final String MSG_STEP_SET = "Step set to ({0}, {1}, {2}).";

    public static final String MSG_INVALID_MAX_DISTANCE =
            "Failed to set maximum distance to {0} - maximum distance must not be 0.";

    public static final String MSG_BACKGROUND_UPDATED = "Background updated.";

    public static final String MSG_INVALID_BACKGROUND_NEEDS_MAX_DISTANCE =
            "Failed to update background - maximum distance must not be 0.";

    public static final String MSG_INVALID_BACKGROUND_NEEDS_STEP =
            "Failed to update background - step distance must not be 0.";
    ...
    public static final String MSG_SELECT_ANIMATION =
            "Select animation (type animation name or exit with ''c''). Existing animations:\n{0}";
